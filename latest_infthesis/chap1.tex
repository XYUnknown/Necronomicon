...
In programming languages studies, it is generally agreed that syntax needed to be provided first, then the semantics can be conveyed via syntactic valid programs.
