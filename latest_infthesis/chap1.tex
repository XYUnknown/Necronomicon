...
One important field of linguistic semantics is \emph{lexical semantics}, which concerns the meaning of words~\citep{palmer1981semantics, PUSTEJOVSKY200698}, including topics such as the semantic structure of words like polysemy and the semantic relations like metaphor and metonymy, lexical fields~\citep{palmer1981semantics} \text{\color{kirby}(todo)}, and lexical relations which studies the structural relation between words like synonymy and antonymy. 
