...
We have designed and implemented a universal method invocation library for Rust.
...
\label{impl:proxy}
In the example discussed in section~\ref{impl:overview}, the syntax is translated by macros. For a declared \texttt{struct}, the macro \texttt{\#[proxy\_me]} performs the translation:
\[
