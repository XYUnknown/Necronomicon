...
\end{definition}
\begin{definition}[Path Conflict] Let $u \overset{\Delta}{\equiv} \pi_{u} \mid x$ and $w \triangleq \pi_{w} \mid y$ be lvals. Then, $w$ is said to conflict with $u$, denoted $u\bowtie w$, if $x = y$.
\end{definition}
