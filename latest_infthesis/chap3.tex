...
\section{The Implementation of Rust xRef Library}
\label{implementation}
Utilising the semantics of remote references presented in dFR, we implement a universal method invocation (UMI) library in Rust. With such a library, a monolithic program can be migrated into a distributed program while preserving the semantics of the monolithic program.
