...
There are some limitations of this project worth mentioning upfront.

Firstly, we do not network failures or concurrency in this project.

Secondly, there are limitations in the formal system we have presented, which are caused by the formal system we build upon. In order to have a better formalisation of our system, it is required to have a better formalisation of the surface language of Rust, which is out of the scope of this project.
