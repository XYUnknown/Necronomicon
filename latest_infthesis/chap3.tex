...
As for a method of a translated \texttt{enum}, the macro \texttt{\#[umi\_enum\_method]} adds an additional pattern matching for the proxy variant to the existing pattern matching.
