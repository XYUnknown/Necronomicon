...
To achieve this, on each UMI server, we use a \emph{resource table} shown in figure~\ref{chap3:impl:tables} with the same lifetime of the server to identify and manage local resources involved in remote computations. Note that the ID in an entry of the table is the ID field in a corresponding proxy.
