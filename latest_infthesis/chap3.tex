...
\mathcal{S} = \mathcal{S}_0 \otimes (\mathscr{l} \mapsto (v, m)) \quad |\mathcal{D}_0| = \mathcal{S}_0\]
...
After the evaluation, we have updated distributed program state and monolithic program state shown as below:
\[\mathcal{D}' = \mathcal{D}_0 \otimes (n' \mapsto (\mathscr{l} \mapsto (v, m))) \quad 
\mathcal{S}' = \mathcal{S}_0 \otimes (\mathscr{l} \mapsto (v, m))\]
To conclude, after the evaluation, the flattened distributed program state and monolithic program store are equal, and the flattened resulting value obtained from the remote evaluation and the value obtained from the monolithic evaluation are equal:
\[
