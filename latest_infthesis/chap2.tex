...
Addressing the issue that application developers are forces to \emph{over-specify} what they mean in a program by committing to choose concrete implementation, the solution proposed by this chapter, which is also the core theme of this chapter, is to design declarative \emph{specifications}. Firstly, they specify the functional correctness of implementations. Secondly, they form an abstraction over concrete implementations, allowing application programmers to better express what they want a computer to do.
