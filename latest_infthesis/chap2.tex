...
One observation is that in an implementation of an application, what an application developer encode tends to be ``all too specific" comparing to what they have modelled in their mind.
