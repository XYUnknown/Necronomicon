...
Container data types, such as sets, lists, and trees, represent collections of data ubiquitous in everyday programming~\citep{DBLP:books/daglib/0023376}. 
Virtually all programming languages provide a variety of different container implementations in their standard libraries.
...
\subsection{The Interaction between Semantic and Syntactic Properties}
